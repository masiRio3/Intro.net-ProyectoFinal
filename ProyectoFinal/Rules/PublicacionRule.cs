    ...
    public class PublicacionRule
    {
        public Publicacion GetOnePostRandom () 
        {
            ...
            var post = new Publicacion
            {
                ...
                Cuerpo=@"<p>Never in all their history have men been able truly to conceive of the world as one: " +
                "a single sphere, a globe, having the qualities of a globe, a round earth in which all the directions" +
                " eventually meet, in which there is no center because every point, or none, is center — an equal earth" +
                " which all men occupy as equals. The airman's earth, if free men make it, will be truly round: a globe " +
                ...
                "become her protectors rather than her violators. That's how I felt seeing the Earth for the first time." +
                ...
                " who will, the experience most certainly changes your perspective. The things that we share in our" +
                ...
                "there is always the thrill of just beginning.</p>\r\n                        " +
                ...
                "And no matter how much progress one makes, there is always the thrill of just beginning.</p>\r\n " +
                "<blockquote class='blockquote'>The dreams of yesterday are the hopes of today and the reality of " +
                "tomorrow. Science has not yet mastered prophecy. We predict too much for the next year and yet far too " +
                "little for the next ten.</blockquote>\r\n                       " +
                " <p>Spaceflights cannot be stopped. This is not the work of any one man or even a group of men. " +
                "It is a historical process which mankind is carrying out in accordance with the natural laws of human " +
                "development.</p>\r\n                       " +
                " <h2 class='section-heading'>Reaching for the Stars</h2>\r\n                        " +
                "<p>As we got further and further away, it [the Earth] diminished in size." +
                " Finally it shrank to the size of a marble, the most beautiful you can imagine. " +
                "That beautiful, warm, living object looked so fragile, so delicate, that if you touched it with a" +
                " finger it would crumble and fall apart. Seeing this has to change a man.</p>\r\n , " +
                ...
                "<p>",
            Creacion= new DateTime(1988,2,18),
            Creador= "Mauricio F. Demasi",
